...
class TDummyData {
  ...
  static final List<BrandCategoryModel> brandCategory = [
    ...
    BrandCategoryModel(brandId: 'S', categoryId: '2'),
  ...
  static final List<ProductCategoryModel> productCotegories = [
  ...
  static final List<ProductModel> products = [
    ProductModel(
      ...
      ProductAttributeModel (name: 'Size', values: ['EU 3D', 'EU 32', 'EU 34']),
    ],
    productVariations: [
