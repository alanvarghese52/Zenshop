                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('10 Jan 2024', style: Theme.of(context).textTheme.headlineSmall),
                    ],
                  ),
                ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('[#645a3]',style: Theme.of(context).textTheme.labelMedium),
                          ],
                        ),
                      ),
                    ],
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('04 Jan 2024',style: Theme.of(context).textTheme.labelMedium),
                          ],
                        ),
                      ),
                    ],
